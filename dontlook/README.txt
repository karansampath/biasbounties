...
* Algorithm-Visualizations.ipynb generates a series of bounty hunters who submit models trained on various demographic features of either the Compas dataset or the ACS folktables dataset, and then feeds these into the updater algorithms in a random order, and visualizes performance across the different groups.
...
* compasData.py: Wrapper code that cleans and loads the COMPAS data.

* compas2yrs.csv: ProPublica's COMPAS dataset, from their GitHub repository https://github.com/propublica/compas-analysis
